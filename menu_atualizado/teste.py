...
imagem_fundo = ctk.CTkImage(Image.open("Calma_aviao.png"), size=(1400, 900))
...
frame_botoes.grid_rowconfigure((0, 2, 9), weight=1)
...
botao_home.grid(row=0, column=0, pady=(20, 0))

linha_divisoria = ctk.CTkFrame(frame_botoes, height=2, width=300, fg_color="gray")
linha_divisoria.grid(row=1, column=0, pady=(10, 10))

frame_botoes.grid_rowconfigure((3, 4, 5, 6, 7), weight=1)
...
botao_cadastro_voo.grid(row=3, column=0, padx=50)
...
botao_consultar_voo.grid(row=4, column=0, padx=50)
...
botao_passageiros_voo.grid(row=5, column=0, padx=50)
...
botao_venda_voo.grid(row=6, column=0, padx=50)
...
botao_cancelar_voo.grid(row=7, column=0, padx=50)
